        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12 pr-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/fidelite" className="text-gray-400 text-sm hover:text-white transition-colors">
                  Programmes de Fidélité
                </a>
              </li>
              <li>
                <a href="/payouts" className="text-gray-400 text-sm hover:text-white transition-colors">
                  Payouts & Incentives
                </a>
              </li>
              <li>
                <a href="/parrainer" className="text-gray-400 text-sm hover:text-white transition-colors">
                  Parrainer & Gagner
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="/politique" className="text-gray-400 text-sm hover:text-white transition-colors">
